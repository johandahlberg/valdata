...
Speculating, based of this data I'd say that the support for SD appears to be related to a higher degree to the difference between cities and rural areas. Which appears to be the primary axis along which Swedish politics is based, rather politics on a left to right scale.
